...
Route::group(['middleware' => ['CheckRole']], function () {
    ...
    Route::get('admin/getUtmSource',['as' => 'getUtmSource','uses' => 'ContactController@getSourceUTM']);
...
route::get('webhook','ThanhvienController@webhook');
route::get('platform','ThanhvienController@platform');
Route::get('test','ThanhvienController@testfunction');
...
Route::get('getFormWebsite/{id}',['as' => 'getFormWebsite','uses' => 'WebsiteController@getForm']);
